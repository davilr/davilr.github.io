...
function initMap() {
  ...
  var centerAachen = new google.maps.LatLng(50.77685, 6.08386)
  var optionsAachen = {
  ...
  var centerMoscow = new google.maps.LatLng(55.74216935, 37.60311127)
  var optionsMoscow = {
	mapTypeControlOptions: {mapTypeIds: ['Styled']},
    center: centerMoscow,
    zoom: 13,
  ...
  var divAachen = document.getElementById('gmAachen');
  var divMoscow = document.getElementById('gmMoscow');
  
  var mapAachen = new google.maps.Map(divAachen, optionsAachen);
  var mapMoscow = new google.maps.Map(divMoscow, optionsMoscow);

  var styledMapType = new google.maps.StyledMapType(styles, {name: 'Styled'});
  mapAachen.mapTypes.set('Styled', styledMapType);
  mapMoscow.mapTypes.set('Styled', styledMapType);

  var image = {
    url: 'files/img/marker.svg',
    size: new google.maps.Size(140, 208),
    scaledSize: new google.maps.Size(24, 36),
    origin: new google.maps.Point(0,0),
    anchor: new google.maps.Point(12, 36)
  };

  var markAachen = new google.maps.LatLng(50.77685, 6.08386);
  var markMoscow = new google.maps.LatLng(55.74216935, 37.60311127);
  

  var markerAachen = new google.maps.Marker({
    draggable: false,
    raiseOnDrag: false,
    icon: image,
    map: mapAachen,
  ...
  google.maps.event.addDomListener(window, 'resize', function() {
    mapAachen.setCenter(centerAachen);
    mapMoscow.setCenter(centerMoscow);
  });  
}