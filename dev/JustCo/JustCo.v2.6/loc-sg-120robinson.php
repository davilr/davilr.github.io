	...
	<section id="home" class="home-section home-parallax home-fade bg-dark-60">
		...
		<div class="hero-slider custom-slider">
			<ul class="slides">
				...
				<li class="bg-dark-30 bg-dark" style="background-image:url(img/banner-singapore-1.jpg)">
                    <div class="custom-container">
                        <div style="position:absolute; bottom:60px;">
                            <h4>Singapore</h4>
                            <div class="custom-page-title">ROBINSON ROAD</div>
                            120 Robinson Road, #15-01 Singapore 968913
                        </div>
                    </div>
				</li>
                
				<li class="bg-dark-30 bg-dark" style="background-image:url(img/banner-singapore-2.jpg)">
                    <div class="custom-container">
                        <div style="position:absolute; bottom:60px;">
                        <h4>Singapore</h4>
                            <div class="custom-page-title">ROBINSON ROAD</div>
				...
				<li class="bg-dark-30 bg-dark" style="background-image:url(img/banner-singapore-3.jpg)">
                    <div class="custom-container">
                        <div style="position:absolute; bottom:60px;">
                        <h4>Singapore</h4>
                            <div class="custom-page-title">ROBINSON ROAD</div>
    ...
    <section style="background-color:#fff; position: relative; padding: 0;">
        ...
        <div class="custom-container">
            <div class="sub-content">
                ...
                <div class="jc-breadcrumb"><span style="color:#999;"><a href="index.html">HOME</a>  &nbsp; /  &nbsp; LOCATIONS  &nbsp; /  &nbsp; </span> <a href="#">ROBINSON ROAD, SINGAPORE</a></div>
                <br>
                <!--h3>Work to the beat of your own drum!</h4><br-->
                <p>Positioned in the dynamic Central Business District of Singapore, our members are steps away from the iconic Lao Pa Sat (a food center that amalgamates the best of local fare), cafes, and bars. The area is as accessible as it is bustling, with MRT stations such as Telok Ayer and Downtown just a stone's throw away.</p><br>
                ...
                <div class="subpage-subcontent">
                  ...
                  <div class="facilities-icon-col">  
                      ...
                      <div style="margin-top:15px;"><div class="facilities-icon"><img src="img/icon-pod.png"></div><p style="padding-top:3px; letter-spacing:2px;">ARCADE & FOOSBALL ROOM</p></div>
                      <div style="margin-top:15px;"><div class="facilities-icon"><img src="img/icon-chem.png"></div><p style="padding-top:3px; letter-spacing:2px;">PINGPONG TABLE</p></div>
                      
                  </div>
                  
                  <div class="facilities-icon-col">  
                      <div style="margin-top:20px;"><div class="facilities-icon"><img src="img/icon-notes.png"></div><p style="padding-top:3px; letter-spacing:2px;">GUEST RECEPTION</p></div>
                      <div style="margin-top:15px;"><div class="facilities-icon"><img src="img/icon-mug.png"></div><p style="padding-top:3px; letter-spacing:2px;">PANTRY</p></div>
                ...
                <div class="subpage-subcontent">
                    ...
                    <div class="subpage-testimonial">
                        <div class="testimonial-img"><img src="img/face-sg-1.jpg" width="100%"></div><br>
						<div class="bubble-speech">
                            <p><span style="color:#0097b2;">"</span>Very appreciative of the great service rendered by the team at JustCo Robinson Road office. No request is too difficult for them and usually can be accommodated. Very responsive team and always greet you with a smile.<span style="color:#0097b2;">"</span> </p><br><!--br><br><br-->
                            <span class="name">Jennifer Lee</span><br>
                            <b style="font-size: 11px;">Navtor Singapore Pte Ltd</b>
                        </div>
                    </div>
                    
                    <div class="subpage-testimonial">
						<div class="testimonial-img"><img src="img/face-sg-2.jpg" width="100%"></div><br>
						<div class="bubble-speech">
							<p><span style="color:#0097b2;">"</span>Happy with the prime location and friendly and supportive staff whom are attentive to our requests.<span style="color:#0097b2;">"</span> </p><br>
							<span class="name">Mitsuru Arakawa</span><br>
                            <b style="font-size: 11px;">Arch Agent Pte Ltd</b>
                        </div>
                    </div>
